...
import bank.exceptions.PreexistingEntityException;
...
public class AdminJpaController implements Serializable {
    ...
    public int getAdminCount() {
     ...
     public Admin login(String str, String password) {
        EntityManager em = getEntityManager();

        return (Admin) em.createQuery(
                "SELECT a FROM Admin a WHERE a.email LIKE :email AND a.password LIKE :password")
